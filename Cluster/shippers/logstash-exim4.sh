...
# This script sets up logstash as a shipper for exim4 sending to redis on backend logstash processors

set -e
# Setup logging
# Logs stderr and stdout to separate files.
exec 2> >(tee "./logstash-exim4.err")
exec > >(tee "./logstash-exim4.log")
...
input {
        file {
                ...
                type => "exim-log"
                sincedb_path => "/var/log/.eximlogsincedb"
        }
}
output {
        redis {
