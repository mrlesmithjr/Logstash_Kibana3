...
# This script sets up logstash as a shipper for postfix sending to redis on backend logstash processors

set -e
# Setup logging
# Logs stderr and stdout to separate files.
exec 2> >(tee "./logstash-postfix.err")
exec > >(tee "./logstash-postfix.log")
...
input {
        file {
                ...
                type => "postfix-log"
                sincedb_path => "/var/log/.postfixlogsincedb"
        }
}
output {
        redis {
